...
from tensorflow.keras.layers import Input, Dense, Layer, GlobalMaxPooling1D, \
    MaxPooling1D, Embedding, Conv1D, Dropout, Flatten
...
class EarlyStoppingAtMinLoss(Callback):
  ...
  """
    def __init__(self, monitor, patience=3, min_epochs=20):
...
class Classifier(): 
    ...
    def build_model(self):                 
        ...
        x = Conv1D(16, 2, activation=self.activation)(x) 
    ...
    def fit(self, train_X, train_y, valid_X=None, valid_y=None,
        ...
        early_stop_callback = EarlyStoppingAtMinLoss(monitor=early_stop_loss, patience=3, min_epochs=50)    
